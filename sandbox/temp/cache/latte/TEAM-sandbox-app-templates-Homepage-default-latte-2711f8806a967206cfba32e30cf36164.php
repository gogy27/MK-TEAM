...
list($_b, $_g, $_l) = $template->initialize('3267633529', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb9b358e4e80_content')) { function _lb9b358e4e80_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbb5c6a5577c_title')) { function _lbb5c6a5577c_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb25c1ec2a83_scripts')) { function _lb25c1ec2a83_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb0329995460_head')) { function _lb0329995460_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
