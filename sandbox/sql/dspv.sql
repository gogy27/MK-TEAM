...
--
-- Hostiteľ: localhost
-- Vygenerované: Út 18.Nov 2014, 17:54
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `str_user_password` varchar(45) DEFAULT NULL COMMENT 'Heslo používateľa v hash forme',
  `str_pass_hash` varchar(45) DEFAULT NULL COMMENT 'Zahashovany string potrebny pri obnove hesla',
...
(1, 'admin', NULL, '$2y$10$l1S.hZLBl8sN1qYhUo.03eYG1gzCrlP3UrNRt.', NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `test`
  ADD CONSTRAINT `FK_GROUPT` FOREIGN KEY (`id_group`) REFERENCES `group` (`id_group`) ON DELETE NO ACTION ON UPDATE NO ACTION;
